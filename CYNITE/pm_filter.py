        ...
        if settings['auto_delete']:
            ...
            btn.insert(0, 
                [
                    InlineKeyboardButton(f'ᴍᴏᴠɪᴇ', 'minfo'),
                    InlineKeyboardButton(f'sᴇʀɪᴇs', 'sinfo'),
                    InlineKeyboardButton(f'ɪɴfᴏ', 'reqinfoo')
                ]
            )
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
                    ...
                    InlineKeyboardButton('sᴜʙsᴄʀɪʙᴇ ᴏᴜʀ ʏᴛ ᴄʜᴀɴɴᴇʟ', url="https://www.youtube.com/@BamelMoviesOfficial")
                  ]]
        ...
        buttons = [[
            InlineKeyboardButton('ᴍᴀɴᴜᴀʟ Fɪʟᴛᴇʀ', callback_data='manuelfilter'),
        ...
        buttons = [[
            InlineKeyboardButton('ʀᴇᴘᴏʀᴛ ʙᴜɢs & fᴇᴇᴅʙᴀᴄᴋ', url=GRP_LNK)
        ],[
            InlineKeyboardButton('ʙᴀᴄᴋᴜᴘ ᴄʜᴀɴɴᴇʟ', url="https://t.me/Bamel_Backup")
        ],[
        ...
        await query.message.edit_text(
            ...
            cnlbtn = [[
                      InlineKeyboardButton('ᴄʜᴀɴɴᴇʟ', url='t.me/Bamel_Backup')
                     ], [
                      InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ', url='t.me/Bamel_Movie_Support'),
                      InlineKeyboardButton('ᴜᴘᴅᴀᴛᴇs', url='t.me/Bamel_Backup')
                     ], [
                      InlineKeyboardButton("⟸ Bᴀᴄᴋ", callback_data="start")
                     ]]
