...
API_ID = int(environ.get('API_ID', '21970746'))
API_HASH = environ.get('API_HASH', '32deb816dc3874e871b6158673fd3683')
BOT_TOKEN = environ.get('BOT_TOKEN', "6252589142:AAG8N-juG13k9yVvoDJ1UuSi_h22AyMPXpg")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get("CHANNELS", "-1001952290232").split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://urlbotboturl:urlbotboturl@urlbot.chezwev.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "Ankur")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Channel Button Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Bamel_Movie_Support')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Bamel_Backup')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Bamel_Movie_Support')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001543295404')).split()]
...
URL_SHORTENR_WEBSITE = environ.get('URL_SHORTENR_WEBSITE', 'greylinks.in')
URL_SHORTNER_WEBSITE_API = environ.get('URL_SHORTNER_WEBSITE_API', '1d5e8f7304fef98403b8af62381c5d017aea83bb')
