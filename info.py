...
BOT_TOKEN = environ.get('BOT_TOKEN', "5971971751:AAEJYE9EGQw7RvtLE1dluzSifgLEy-HlvL4")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001868005435').split()]
...
URL_SHORTNER_WEBSITE_API = environ.get('URL_SHORTNER_WEBSITE_API', '2da8c82a119f2f2e4bd5d1c9ae66f9d1fe0e1253')
